<!-- If you update this, you probably also want to update the Migration and Metro documents -->
# Async-DR
...
11. Refer back to the MigrationSchedule and how creating it will trigger the creation of a Migration object every 2 minutes (in our case). Show the Migration objects:
